...
function getAllOUs() {
    ...
    .then((orgUnits) => {
        orgUnits.sort(pathDepthSort); // sort by file depth
...
*/
function pathDepthSort(ou1, ou2) {
    pathDepth1 = (ou1['orgUnitPath'].match(/\//g) || []).length;
    pathDepth2 = (ou2['orgUnitPath'].match(/\//g) || []).length;
